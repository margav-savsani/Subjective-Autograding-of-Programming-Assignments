...
bool BST::insert(int jrnyCode, int price)
{
  ...
  // see fit.
    ...
    updateBSTParentChild(a,prnt,left);
    bool left1 = false;
    TreeNode* b = a->parent;
    if (b->left == a) left1 = true;
    while (b != nullptr){
        if (left1){
            if (b->right == nullptr) b->height = (b->left)->height + 1;
            else {
                if (b->height == (b->left)->height) {
                    b->height++;
                }
                else{
                    break;
            ...
            if (b->left == nullptr) b->height = (b->right)->height + 1;
            else {
                if (b->height == (b->right)->height) {
                    b->height++;
                }
                else{
                    break;
