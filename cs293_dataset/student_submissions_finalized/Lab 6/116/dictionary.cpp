...
Dictionary<T>::Dictionary(){
    N = DICT_SIZE; //N =64;max size of dictionary possible.
    numFilled = 0;  //initialized to 0.
    A = new Entry<T>[N]; // defines an array of type Entry which has a string key and a value of type T of max size 64.
    if (A == nullptr) {
