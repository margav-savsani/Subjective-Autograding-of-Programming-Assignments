...
class TrieNode {
 public:
  ...
  int numNonNullBranches; //Store total number of non NULL branches from this node.
...
class Trie {
 ...
 public:
  ...
  listOfObjects<string> *allstation(TrieNode *current, listOfObjects<string> *currentend, listOfObjects<string> * totalcompletions);
