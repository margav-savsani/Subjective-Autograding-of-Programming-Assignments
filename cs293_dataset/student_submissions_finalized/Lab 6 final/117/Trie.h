...
class Trie {
 private:
  ...
  bool recursiveAddCompletions(TrieNode *node, listOfObjects<string> *head, listOfObjects<string> *tail);
  bool addCompletions(TrieNode *node, listOfObjects<string> *head, listOfObjects<string> *tail);
