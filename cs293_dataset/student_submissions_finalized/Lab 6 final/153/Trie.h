...
/**
 * @brief A node class implementing an object corresponding to a specific character following it's parent node. 
 * 
 */
class TrieNode {
 public:
...
class Trie {
 private:
  ...
  TrieNode* makePath(TrieNode* begin, string sub_str);
  void pruneTrie(TrieNode* node);
