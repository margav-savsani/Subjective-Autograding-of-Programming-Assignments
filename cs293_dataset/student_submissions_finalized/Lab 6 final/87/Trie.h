...
class Trie {
 ...
 public:
  ...
  //void reccom(TrieNode *someNode, listOfObjects<string> *currCompletions);
  void printTrie();
  void recursivePrintTrie(TrieNode *root, const string& prefix, int branchId, bool siblingsToRight);
};
