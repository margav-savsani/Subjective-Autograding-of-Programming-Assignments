...
public:
	...
	int getMinimum();
        ...
        void print_code(TreeNode * node);

        TreeNode * get_min(TreeNode * top);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void print_val(TreeNode *node,ofstream &outfile);
        //loads teh tree
        void customLoad (int flag, string filename);
        //performs chcek on the value
        void in_order_check(TreeNode * node, int & counter,int lowerPriceBound, int upperPriceBound );
        //performs Euler traversal
        void Euler_travers (TreeNode*node,ofstream & outfile);
