...
bool AVLTree::rotateLeftLeft(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode)
{
  ...
  if (greatGrandParentNode->left == grandParentNode) {
    ...
    cerr << "Unexpected condition encountered!" << endl;            //this is a new thing I encountered, cerr is like cout but for errors with added functionality that is stops the program after displaying message!
    return false;
  }
...
bool AVLTree::rotateRightLeft(TreeNode *currNode, TreeNode *parent, TreeNode *grandParent)
{
  ...
  // First finding if grandParentNode is the left or right child of
  // greatGrandParentNode
  bool isGPRightChild;
...
bool AVLTree::insert(int jrnyCode, int price)
{
  ...
  x->price = price;
  if(AVLLessThan(x,root)) root->left;
