...
bool AVLTree::rotateRightLeft(TreeNode *currNode, TreeNode *parent, TreeNode *grandParent)
{
  ...
  // Copying the code for rotateLeftRight as both cases are symmteric cases
  // of each other, would make appropriate chanhes into it later.
...
bool AVLTree::rotateRightRight(TreeNode *currNode, TreeNode *parent, TreeNode *grandParent)
{
  ...
  // Trying to note that the it is ssymmteric case as rotateLeftLeft, copying the exact
  // same code, will make appropriate changes in it.
  TreeNode *greatGrandParentNode = grandParent->parent;
  bool isGPLeftChild;
  if (greatGrandParentNode->left == grandParent)
  {
