...
bool AVLTree::rotateLeftRight(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode)
{
  ...
  // tha  // We use "true" as the third argument of the following call to indicate
  //t T3 should become the left child of grandParentNode
  updateAVLParentChild(T3, grandParentNode, true);
...
{  TreeNode* curr = root;
   TreeNode* dummy;
   dummy = new TreeNode(jrnyCode,123);
   if(!AVLLessThan(root,dummy) && !AVLLessThan(dummy,root)){
