...
bool BST::insert(int jrnyCode, int price){
  ...
  if (BSTLessThan(z, root)){
    ...
    if(root->left!=nullptr){
      ...
      // BST(root->left,perComparisonCost, perParentChildUpdateCost).insert(jrnyCode, price);
    ...
    if(root->right!=nullptr){
      BST(root->right, perComparisonCost, perParentChildUpdateCost).insert(jrnyCode, price);
      return true;
    }      
    else{
      root->right=z;
