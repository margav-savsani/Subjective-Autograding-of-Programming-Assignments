...
int minimum(TreeNode* root){ // to find minimum length of a TreeNode

	int shortestPathLength;
	if(root == nullptr) shortestPathLength = 0;
  	 ...
  	 if ( a<=b){
  	 	...
  	 	shortestPathLength = 1+ a;
  	 }
  	 else{
  	 
  	 	shortestPathLength = 1+ b;
  	 } 	
...
int maximum(TreeNode* root){// to find maximum length of a TreeNode
  
  	int longestPathLength;
  	if(root == nullptr ) longestPathLength = 0;
  	 ...
  	 if ( a>=b){
  	 	...
  	 	longestPathLength = 1+ a;
  	 }
  	 else{
  	 
  	 	longestPathLength = 1+ b;
  	 } 	
...
public:
  ...
  int maxii(){ // added this to know the longest path of the tree
  
  	return maximum(root);
  }
  int minii(){// added this to know the shortest path of the tree
