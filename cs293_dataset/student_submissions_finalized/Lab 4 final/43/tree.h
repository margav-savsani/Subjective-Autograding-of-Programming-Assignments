...
public:
  ...
  // Constructors!
  BST() {root = new TreeNode(); shortestPathLength = 0; longestPathLength = 0;}
  BST(TreeNode *curr_root) {root = curr_root; shortestPathLength = 1; longestPathLength = 1;}
