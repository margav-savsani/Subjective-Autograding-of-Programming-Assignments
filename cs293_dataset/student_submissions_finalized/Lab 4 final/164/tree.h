...
struct TreeNode{
  ...
  TreeNode *parent;	// The Parent Node, NULL in case of Root// Length of longest path from this node to a leaf
  ...
  //   return (longestPath(this) - shortestPath(this));
  // }
...
public:
  ...
  bool find(int JourneyCode, int price);
    TreeNode* get(int JourneyCode, int price);
