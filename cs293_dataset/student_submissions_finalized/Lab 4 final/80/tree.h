...
struct TreeNode{
  ...
  int getImbalance()
  {
    shortestPathLength=getshortest();
    longestPathLength=getlongest();
  ...
  int getshortest(){
    if (left==nullptr && right==nullptr){
      ...
      return 1+right->getshortest();
    }
    else if(right==nullptr){
      return 1+left->getshortest();
    }
    else{
      return min(1+left->getshortest(), 1+right->getshortest());
    }
  ...
  int getlongest(){
    if (left==nullptr && right==nullptr){
      ...
      return 1+right->getlongest();
    }
    else if(right==nullptr){
      return 1+left->getlongest();
    }
    else{
      return max(1+left->getlongest(), 1+right->getlongest());
    }  }
