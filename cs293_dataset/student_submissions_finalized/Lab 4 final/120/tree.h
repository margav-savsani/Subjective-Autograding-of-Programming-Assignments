...
public:
  ...
  int getImbalance()
  {
    ...
    shortestPathLength=this->shortest();
    longestPathLength=this->longest();
  ...
  int shortest(){
    if(this->left==nullptr && this->right==nullptr){
      ...
      return 1+this->right->shortest();
    }
    else if(this->right==nullptr){
      return 1+this->left->shortest();
    }
    else{
      if(this->left->shortest()<this->right->shortest()){
        return 1+this->left->shortest();
      }
      else{
        return 1+this->right->shortest();
  ...
  int longest(){
     if(this->left==nullptr && this->right==nullptr){
      ...
      return 1+this->right->longest();
    }
    else if(this->right==nullptr){
      return 1+this->left->longest();
    }
    else{
      if(this->left->longest()>this->right->longest()){
        return 1+this->left->longest();
      }
      else{
        return 1+this->right->longest();
