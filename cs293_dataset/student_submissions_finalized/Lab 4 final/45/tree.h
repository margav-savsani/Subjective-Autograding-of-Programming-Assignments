...
struct TreeNode{
  ...
  int shortestPathLength;//=spl();
  int longestPathLength;//=lpl();
  // if(root==nullptr){
  ...
  // }
   // Length of shortest path from this node to a leaf
                          // where a nullptr leaf contributes a path of length 0
    // Length of longest path from this node to a leaf
                         // where a nullptr leaf contributes a path of length 0
...
// void asl(TreeNode* x){
//   x->shortestPathLength=x->spl();
//   x->longestPathLength=x->lpl();
// }
