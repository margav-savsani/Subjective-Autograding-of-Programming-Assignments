    ...
    if (currNode->JourneyCode < JourneyCode) {
      ...
      currNode = currNode->left;
        ...
        // node with only one child or no child
            ...
            struct TreeNode* temp1 = currNode->right;
            ...
            struct TreeNode* temp2 = currNode->left;
        ...
        struct TreeNode* temp1 = findSuccessor(currNode->right);
         if (temp1->left!=NULL){
         struct TreeNode* temp2=temp1->left;
                  &temp2==&temp1;
