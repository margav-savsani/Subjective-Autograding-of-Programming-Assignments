...
public:
  ...
  void change_code(unsigned int JourneyCode);// member function for accessing private variable journeycode 
  void change_price(unsigned int price); //member function for accessing private variable price
