...
struct TreeNode{
  ...
  int getLongestright(){
    if (right==NULL){
      ...
      return right->longestPathLength;
    }
  }
  ...
  int getLongestleft(){
    if (left==NULL){
      ...
      return left->longestPathLength;
    }
  }

  int getShortestright(){
    if (right==NULL){
      return 0;
    }
    else {
      return right->shortestPathLength;
    }
  }
  ...
  int getShortestleft(){
    if (left==NULL){
      ...
      return left->shortestPathLength;
    }
  }
...
public:
  ...
  int getshortest(){
    return root->shortestPathLength;
  }
