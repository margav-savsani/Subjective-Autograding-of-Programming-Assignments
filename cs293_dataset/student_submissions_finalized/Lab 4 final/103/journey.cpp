...
int Journey::numComparisonsTotal = 0;
...
bool Journey :: operator < (Journey const &j) { numComparisonsTotal++; if(JourneyCode < j.JourneyCode) return true; else return false;} // Usage: if (journey1 < journey2) {...}
