...
struct TreeNode{
  ...
  int shortest(TreeNode* rt); // helper function to calculate shortest path from this node
  int longest(TreeNode* rt); // helper function to calculate longest path from this node
  ...
  int getImbalance()
  {
    ...
    longestPathLength = longest(this);
    shortestPathLength = shortest(this);
