...
struct TreeNode{
  ...
  TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr),longestPathLength(0), shortestPathLength(0){}
  
  TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr),longestPathLength(0),shortestPathLength(0){}
  
  TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent,int LongestPathLength,int shortestPathLength) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent), longestPathLength(longestPathLength),shortestPathLength(shortestPathLength){}
...
public:
  ...
  void change_imbalance(TreeNode* a);
  ...
  TreeNode* get_Minimum(TreeNode* n);
