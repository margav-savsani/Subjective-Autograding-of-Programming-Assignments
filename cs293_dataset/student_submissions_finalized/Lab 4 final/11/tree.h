...
struct TreeNode{
  ...
  TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr),parent(nullptr) {}
  
  TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr) {}
  TreeNode(int jrnyCode, int jrnyPrice , TreeNode *parent1 ) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr) , parent(parent1){}
