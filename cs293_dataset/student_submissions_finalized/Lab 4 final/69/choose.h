...
int choose_one(Journey* x, int start, int finish); 
int choose_two(Journey* x, int start, int finish);
int choose_three(Journey* x, int start, int finish);
int choose_four(Journey* x, int start, int finish);
