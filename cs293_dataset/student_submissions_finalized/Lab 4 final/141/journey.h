...
public:
  ...
  void inputJourney(int JourneyCode, int price){this->JourneyCode = JourneyCode; this->price = price;}
  ...
  bool operator== (Journey const &j); // Overload operator. Usage : if (journey1 == journey 2)
};
