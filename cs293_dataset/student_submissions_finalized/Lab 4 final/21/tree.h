...
struct TreeNode{
  ...
  TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr), shortestPathLength(1), longestPathLength(1)  {}
  
  TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr), shortestPathLength(1), longestPathLength(1) {}
  
  TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent), shortestPathLength(1), longestPathLength(1) {}
