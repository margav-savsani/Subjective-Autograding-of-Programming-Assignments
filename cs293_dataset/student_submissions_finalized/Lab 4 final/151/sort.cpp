...
bool SorterTree::insertPivot(int JourneyCode, int price){
    bool flag;
    flag = tree->insert(JourneyCode, price, comparisons);
    return flag;
}
...
bool SorterTree::QuicksortWithBSTInsert(int start, int finish)
{
    ...
    int pivot_pos = i+1;
    swap(array[pivot_pos], array[finish]);
    ...
    QuicksortWithBSTInsert(start, pivot_pos - 1);
    QuicksortWithBSTInsert(pivot_pos + 1, finish);
