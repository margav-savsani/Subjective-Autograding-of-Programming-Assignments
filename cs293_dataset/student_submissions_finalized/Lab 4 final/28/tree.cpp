...
bool BST::insert(int JourneyCode, int price)
{
  ...
  // similar to what you had done in lab assignment 3.
    ...
    if (prev->JourneyCode > JourneyCode)
    {
      prev->left = node;
      node->parent = prev;
      // return true;
    ...
    // while (temp1 != NULL)
    // {
    //   temp1->longestPathLength = temp1->longpath(); // updating the values
    //   temp1->shortestPathLength = temp1->shortpath();
    //   if (temp1->JourneyCode > JourneyCode)
    //   {
    //     prev1 = temp1;
    //     temp1 = temp1->left;
    //   }
    //   else if (temp1->JourneyCode < JourneyCode)
    //   {
    //     prev1 = temp1;
    //     temp1 = temp1->right;
    //   }
