...
struct TreeNode
{
  ...
  // Will be called when we are inserting something in BST
  // void update_insert_pathlength(int value)
  // {
  //   if (value > longestPathLength)
  //   {
  //     shortestPathLength = longestPathLength;
  //     longestPathLength = value;
  //   }
  //   else
  //     shortestPathLength = value;
  // }
};
