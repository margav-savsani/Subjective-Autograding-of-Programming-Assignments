...
struct TreeNode{
  ...
  TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent, int shortest, int longest) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent), shortestPathLength(shortest), longestPathLength(longest) {}
