...
struct TreeNode
{
  ...
  int shortestlength()//return shortestest path
  {
    if ((left == NULL || right == NULL))
    {
      return 0;
    }
    else if (left->shortestlength() > right->shortestlength())
    {
      return 1 + right->shortestlength();
    }
    else
      return 1 + left->shortestlength();
  }
  int longestlength()//return longest path
  {
    if (left == NULL && right == NULL)
    {
      return 0;
    ...
    if ((left != NULL && right != NULL))
    {
      ...
      {
        return 1 + left->longestlength();
      }
      return 1 + right->longestlength();
    }
    else if (left != NULL)
    {
      return 1 + left->longestlength();
