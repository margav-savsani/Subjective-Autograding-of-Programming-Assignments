...
struct TreeNode{
  ...
  TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr) {price=0;JourneyCode=0;}
  TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr),parent(nullptr) {price=jrnyPrice;JourneyCode=jrnyCode;left=nullptr;right=nullptr;parent=nullptr;}
  TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent) {price=jrnyPrice;JourneyCode=jrnyCode;left=leftChild;right=rightChild;parent=parent;}
...
public:
  ...
  int shorter(TreeNode* r); 
  int longer(TreeNode* r); 
  void setforall(TreeNode* x);
