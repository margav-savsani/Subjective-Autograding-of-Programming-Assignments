...
public:
  ...
  //Destroying all nodes recursively
  ...
  //Added new function to update shortestPathLength and longestPathLength
  void updateLengths(TreeNode* parentOfCurrNode);
