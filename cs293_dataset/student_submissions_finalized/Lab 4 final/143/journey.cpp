...
Journey::Journey(){ JourneyCode = -1; price = -1; } //constructor initialisation
    
Journey::Journey(unsigned int c, unsigned int p)  //constructor initialisation
{
    JourneyCode = c;
    price = p;
}

unsigned int Journey::getJourneyCode(){ return JourneyCode; }//returns JourneyCode
unsigned int Journey::getPrice(){ return price; } //returns price
