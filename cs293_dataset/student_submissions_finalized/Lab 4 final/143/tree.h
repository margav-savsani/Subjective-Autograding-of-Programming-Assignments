...
struct TreeNode{
  ...
  TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr) {shortestPathLength=0;longestPathLength=0;shortestpathlength2=0;}
  
  TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr) {shortestPathLength=0;longestPathLength=0;shortestpathlength2=0;}
  
  TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent) {shortestPathLength=0;longestPathLength=0;shortestpathlength2=0;}
...
public:
  ...
  TreeNode *successor(TreeNode *ele);
