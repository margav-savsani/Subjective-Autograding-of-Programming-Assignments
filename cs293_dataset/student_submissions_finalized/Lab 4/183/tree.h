...
struct TreeNode{
  ...
  TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr),parent(nullptr) {price=jrnyPrice;JourneyCode=jrnyCode;shortestPathLength=0;longestPathLength=0;}
