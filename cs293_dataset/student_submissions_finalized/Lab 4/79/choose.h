...
/*
We have an array Arr[] of type double.
A pointer to an element of the array is known (ptr).
We need to find its index in the array.
Arr -> pointer of type double to first element
Arr + i -> pointer of type double to the ith element
(ptr - Arr)
*/