...
class BST{
  ...
  int shortestLengthTree;
  int longestLengthTree;
...
public:
  ...
  // Constructors!
  BST() {root = nullptr; shortestLengthTree = longestLengthTree = 0;}
  BST(TreeNode *curr_root) {root = curr_root; shortestLengthTree = longestLengthTree = 1;}
