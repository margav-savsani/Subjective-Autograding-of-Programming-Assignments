...
struct TreeNode
{
    ...
    TreeNode(Journey jrny, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrny.getPrice()), JourneyCode(jrny.getJourneyCode()), left(leftChild), right(rightChild), parent(parent) {}
