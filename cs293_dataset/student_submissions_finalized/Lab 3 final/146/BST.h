...
public:
	...
	bool insert(int JourneyCode, int price);
        ...
        //Inserts element in the tree having root as node
        bool insert(int JourneyCode, int price, TreeNode* node);


	// Return true, if the ticket with given attributes is found, false otherwise
	bool find(int JourneyCode, int price);

        //Find inside tree with root at root
        bool find(int JourneyCode, int price, TreeNode *root);
	...
	bool remove(int JourneyCode, int price);
        ...
        bool remove(int JourneyCode, int price, TreeNode *root);
	...
	void traverse(int typeOfTraversal);
        ...
        //To traverse a tree with given root
        void traverse(int typeOfTraversal, TreeNode *root);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        void countJourneysInPriceBound(int &lowerPriceBound, int &upperPriceBound , TreeNode *root, int &ans);
	...
	void storeTraverse(TreeNode *node, ofstream &f);
