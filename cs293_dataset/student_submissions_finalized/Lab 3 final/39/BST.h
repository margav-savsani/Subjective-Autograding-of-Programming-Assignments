...
public:
	...
	bool find(int JourneyCode, int price);
        ...
        bool findJC(int journeyCode);

        //finds and returns the node with the given JC, irrespective of price. if found, NULL otherwise
        struct TreeNode* findNode(int journeyCode);
