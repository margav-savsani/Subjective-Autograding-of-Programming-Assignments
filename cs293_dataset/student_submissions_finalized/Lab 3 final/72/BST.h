...
public:
	...
	bool remove(int JourneyCode, int price);
        ...
        //Myfunctions
        void preorderTraverse(TreeNode *base);
        void postorderTraverse(TreeNode *base);
        void inorderTraverse(TreeNode *base);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        void myCount(int lb, int ub, TreeNode *base, int &cnt);
