...
public:
	...
	bool find_j(int JourneyCode,int price);
	...
	bool find(int JourneyCode, int price);
        TreeNode * findnode(int JourneyCode, int price);                             //returns pointer to node
	...
	void traverse(int typeOfTraversal);
        void traversal(int typeofTraversal , TreeNode * treenode);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int count(int lowerPriceBound, int upperPriceBound , TreeNode* strt , int &countss);
	...
	// Store the current tree in a file called filename.  You should
        ...
        void customprint(TreeNode* x , ofstream *s);       //supporting function in customstore
	...
	// While loading a tree from a file written by customStore, we
        ...
        void custominput(TreeNode* &base ,TreeNode* par , ifstream* infile);            //supporting function for customload
