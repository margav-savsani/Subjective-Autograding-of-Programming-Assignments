...
public:
    ...
    bool recurse_insert(int JourneyCode, int price, TreeNode *node);   // extra function
    ...
    bool recurse_find(int JourneyCode, int price, TreeNode *node); // extra function


	// Return true, if the ticket with given attributes is found, false otherwise
	bool find(int JourneyCode, int price);
    
    bool smallest(TreeNode *del_node, TreeNode *node);
    
    bool largest(TreeNode *del_node, TreeNode *node);
    
    bool recurse_remove(int JourneyCode, int price, TreeNode *node);
    ...
    void recurse_traverse_0(TreeNode *node);
    
    void recurse_traverse_1(TreeNode *node);
    
    void recurse_traverse_2(TreeNode *node);
    ...
    int recurse_getMinimum(TreeNode *node);
    ...
    int cnt(int lower_bound, int upper_bound, TreeNode *node);
    ...
    void store_left(ofstream &file, TreeNode *node);
    
    void store(ofstream &file, TreeNode *node);
    
    void store_start(ofstream &file, TreeNode *node);
    ...
    void load(ifstream &f, TreeNode *node);
    
    void load_left(ifstream &f, TreeNode *node);
