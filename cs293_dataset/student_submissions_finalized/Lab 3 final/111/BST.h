...
public:
	...
	struct TreeNode *search(int price);
	// Returns false, if JourneyCode isn't present
	// Deletes the corresponding entry and returns True otherwise
 	bool remove(int JourneyCode, int price);
        struct TreeNode *successor(struct TreeNode *n);	
        struct TreeNode *predecessor(struct TreeNode *n);
         struct TreeNode *printPreorder(struct TreeNode *n);
          struct TreeNode *printInorder(struct TreeNode *n);
           struct TreeNode *printPostorder(struct TreeNode *n);	
