...
struct TreeNode{
    ...
    //function to traverse the tree node by node
    void inorder();
    void preorder();
    void postorder();

    //function to be used to count number of journeys in given bound
    void travel(int lower,int upper, int &count);
};
...
public:
	...
	int getMinimum();
        ...
        //function to get immediate successor of a node in BST
        TreeNode *successor(TreeNode *x);

        //function to return the node with min price in a given subtree
