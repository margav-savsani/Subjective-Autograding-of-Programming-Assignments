...
public:
	...
	bool find(int JourneyCode, int price);
        TreeNode* superfind(int JourneyCode,int price);
	...
	int getMinimum();
        ...
        void visit1(TreeNode * T);
        void visit2(TreeNode * T);
        void visit3(TreeNode * T);
        void supervisit(TreeNode * T,int lowerPriceBound, int upperPriceBound,int& I);
        void superpreorder(TreeNode * T,ofstream &file);
        // ****************************************************************
	// Methods for Part II
