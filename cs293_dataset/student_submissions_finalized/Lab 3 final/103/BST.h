...
class BST{
	...
	TreeNode *root;
        ...
        // Hashset storing JourneyCodes present in the BST
        unordered_set<int> journeyCodesPresent;
	...
	vector<string> result;
        ...
        TreeNode* findHelper(int JourneyCode, int price, TreeNode* cnode);

        // Helper function for implementing TRAVERSE
        void traverseHelper(int typeOfTraversal, TreeNode* cnode);
        
        // Function for finding the successor of a node
        TreeNode* successor(TreeNode* node);

        // Helper function for implementing countJourneysInPriceBound
        int countJourneysInPriceBoundHelper(int lowerPriceBound, int upperPriceBound, TreeNode* cnode);

        // Traversal function for storing
        void saveTraverse(vector< pair<int, int> >& list, TreeNode* cnode);

        // Traversal function for loading
        void loadTraverse(vector< pair<int, int> >& list, int& idx, TreeNode* cnode);

        // Function for converting BST to list to be stored
        vector< pair<int, int> > saveBSTList();

        // Function for converting list stored to BST
        void loadBSTList(vector< pair<int, int> > list);
