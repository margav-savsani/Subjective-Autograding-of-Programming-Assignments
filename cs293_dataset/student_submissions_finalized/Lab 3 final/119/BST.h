...
// const int MAX_POSSIBLE_PRICE = 1000000;
...
public:
	...
	int getMinimum();
        ...
        void pre_order_traversal(TreeNode *v);
        void post_order_traversal(TreeNode *v);
        void in_order_traversal(TreeNode *v);
        TreeNode *successor_for_delete(TreeNode *v);
	...
	void customStore(string filename);
        void preOrderTrav_for_customStore(ofstream &f, TreeNode *v);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void preOrderTrav_for_customLoad(ifstream &f, TreeNode *v, string specifier);

        int inOrderTrav_for_bound(TreeNode *v, int l, int h);
