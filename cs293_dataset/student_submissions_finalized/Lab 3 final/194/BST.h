...
public:
	...
	int getMinimum();
        ...
        //recursive traversal
        void recursive_traverse(TreeNode* node ,int typeOfTraversal);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        //this function is called inside the above function and calculates the number of nodes
        int countPrice(TreeNode* node, int lowerPriceBound, int upperPriceBound);
	...
	void customStore(string filename);
        ...
        void Store(TreeNode * node,int *arr ,int *price_arr,int location);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void recursive_load(TreeNode * node,int **arr, int pstn,int max);
