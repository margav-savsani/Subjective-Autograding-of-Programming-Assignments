...
public:
	...
	bool remove(int JourneyCode, int price);
        ...
        struct TreeNode* search(int JourneyCode, int price);
        struct TreeNode* Succ(TreeNode *x);
        struct TreeNode* TreeMinimum(TreeNode *x) ;
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int countjourneys(TreeNode *x,int lowerPriceBound, int upperPriceBound) ;
	...
	void customStore(string filename);
        void eulertraverse(string filename, TreeNode * x) ;
