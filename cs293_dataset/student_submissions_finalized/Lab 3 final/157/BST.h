...
public:
	...
	int getMinimum();
        TreeNode* nodemin(TreeNode *node1);
        TreeNode * sucscr(TreeNode * node1);
        void preorder(TreeNode *node1);
        void postorder(TreeNode *node1);
        void inorder(TreeNode *node1);
        void inorder1(TreeNode *node1, int *arr, int &ind);
        TreeNode* treecreate(int *arrj, int*arrp, int &insind, int minp, int maxp,int count1, TreeNode *par);
        void preorder1(TreeNode *node1,int *arrjc, int *arrpc, int *ind);
