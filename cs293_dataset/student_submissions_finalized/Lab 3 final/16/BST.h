...
public:
	...
	int getMinimum();
        ...
        // Extra 3 functions added by me to assisst in traversing
        void preord(TreeNode *cur_root);
        void postord(TreeNode *cur_root);
        void inord(TreeNode *cur_root);

        // ****************************************************************
	// Methods for Part II

        // Extra function to assist the bound function
        void range_help(TreeNode *cur_root, int min, int max, int &count);
	...
	// Store the current tree in a file called filename.  You should
        ...
        // Extra function needed to assist the customStore function
        void fileread(ofstream &out, TreeNode *cur_root);
