...
struct TreeNode{
    ...
    friend bool operator<(TreeNode a, TreeNode b); //returns true if a<b
    friend bool operator>(TreeNode a, TreeNode b); //returns true if a>b
    friend bool operator<=(TreeNode a, TreeNode b); //returns true if a<=b
    friend bool operator>=(TreeNode a, TreeNode b); //returns true if a>=b
    friend bool operator==(TreeNode a, TreeNode b); //returns true if a==b
...
public:
	...
	bool find(int JourneyCode, int price);
        ...
        //searches for journey code by traversing entire tree
        //returns NULL if not found
        bool search_journey(int JourneyCode);
	...
	int getMinimum();
        ...
        //Returns the most expensive journey node
        TreeNode* getMaximum();
	...
	// Store the current tree in a file called filename.  You should
        ...
        void preorder_print(ofstream& file);
