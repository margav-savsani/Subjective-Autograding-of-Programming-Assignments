...
public:
	...
	bool remove(int JourneyCode, int price);
        ...
        TreeNode* getMaximum(TreeNode* y);
	...
	void traverse(int typeOfTraversal);
        ...
        void treeTraverse(TreeNode* node, int typeOfTraversal);

        void external(TreeNode* node, int typeOfTraversal);
        void left(TreeNode* node, int typeOfTraversal);
        void right(TreeNode* node, int typeOfTraversal);
        void below(TreeNode* node, int typeOfTraversal);
	...
	int countPrice(TreeNode* x, int lowerPriceBound, int upperPriceBound);
	...
	void customStore(string filename);
        ...
        void modpre_order(TreeNode* x, ofstream &file);
	// While loading a tree from a file written by customStore, we
        ...
        void splitter(string str, char seperator);
