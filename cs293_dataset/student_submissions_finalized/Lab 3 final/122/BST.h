...
public:
	...
	bool fun(TreeNode *ptrc,int JourneyCode,int price);
	bool function(TreeNode *ptr, int JourneyCode,int price);
	
	TreeNode* min(TreeNode *n);
TreeNode* del(TreeNode *r, int key);
	//int preordersum(TreeNode *ptr,int lowerPriceBound, int upperPriceBound);
