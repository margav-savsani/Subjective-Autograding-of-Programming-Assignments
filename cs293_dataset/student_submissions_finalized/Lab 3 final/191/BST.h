...
public:
	...
	//myfind returns the pointer to the node to be found or null if no such node exists 
	TreeNode* myfind(int JourneyCode, int price);
	...
	//these methos are for the specific implemetnaiton of inorder preorder and postporder traversal which are recursively calling themselves
	void traverse_in(TreeNode *ptr);
	void traverse_pre(TreeNode *ptr);
	void traverse_post(TreeNode *ptr);
	...
	// Returns the count of journeys that are at least as expensive
		...
		int myrange(int lowerPriceBound, int upperPriceBound, TreeNode *ptr);
	...
	void mystore(ofstream &file, TreeNode *ptr);
