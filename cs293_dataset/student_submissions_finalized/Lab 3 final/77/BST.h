...
public:
	...
	bool remove(int JourneyCode, int price);
        TreeNode* predecessor(TreeNode* curr);  // To find the predecessor.
	...
	void traverse(int typeOfTraversal);
        void preOrder(struct TreeNode *root);  // To get recursive algorithm, I created new functions.
        void postOrder(struct TreeNode *root); // To get recursive algorithm, I created new functions.
        void inOrder(struct TreeNode *root);   // To get recursive algorithm, I created new functions.
	...
	int BOUNDS(struct TreeNode *root,int lowerPriceBound, int upperPriceBound); // I created new function for Bounds
	...
	void customTreeStorePreOrder(string filename,struct TreeNode *root); // I created new function for storage of pre-order
	struct TreeNode* constructBST( const vector<TreeNode*> &PREORDER,int &pIndex, int start, int end); // I created new function for loading new BST/Left of BST.
