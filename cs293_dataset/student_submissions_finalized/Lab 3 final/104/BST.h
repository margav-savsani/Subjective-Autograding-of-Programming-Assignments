...
class BST{
	...
	vector<string> result;
        ...
        void boundHelper(TreeNode *t, int lower, int higher, int &count);
        void storeHelper(TreeNode *t, ofstream &file);
        void loadHelper(TreeNode *&t, TreeNode *prnt, ifstream &file);
