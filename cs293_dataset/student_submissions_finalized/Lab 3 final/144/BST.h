...
class BST{
	...
	vector<string> result;
        ...
        //Helper functions not accessible to user
        bool find(int JourneyCode, TreeNode* node_ptr);
        bool find(int JourneyCode, int price, TreeNode* node_ptr);
	void traverse(int typeOfTraversal, TreeNode* node_ptr);
        int countJourneysInPriceBound(int lowerPriceBound, int upperPriceBound, TreeNode* node_ptr);
        void customStore(ofstream& outfile, TreeNode* node_ptr);
