...
class BST{
	...
	vector<string> result;
        ...
        bool removeelem(int JourneyCode, int price, TreeNode *root);
        TreeNode* getMInimumVal(TreeNode *root);
        int countJourneysInPriceBound(int lowerPriceBound, int upperPriceBound, TreeNode *root);
