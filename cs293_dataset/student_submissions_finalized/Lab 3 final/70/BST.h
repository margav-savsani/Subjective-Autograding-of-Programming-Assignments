...
public:
	...
	bool insert(int JourneyCode, int price);
        ...
        //returns the successor node of the node if available
	...
	bool remove(int JourneyCode, int price);
        ...
        void writeInFile(TreeNode* node, ofstream* filename);
        void preorderTraverse(TreeNode* node, ofstream* filename);
	...
	void traverse(int typeOfTraversal,ofstream* filename);
