...
public:
	...
	bool find(int JourneyCode, int price);
        ...
        struct TreeNode *successor(TreeNode *x);
	...
	int pricebound(int lower,int upper, TreeNode *x);
	// Store the current tree in a file called filename.  You should
        ...
        void store(ofstream &out ,TreeNode *x);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void load(ifstream &in, TreeNode *x, int flag);
