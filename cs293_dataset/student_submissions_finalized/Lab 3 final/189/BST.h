...
public:
	...
	// Inserts the element and returns True otherwise
        bool Insert(int JourneyCode, int price, TreeNode* x);
	bool insert(int JourneyCode, int price);


	// Return true, if the ticket with given attributes is found, false otherwise
        bool Find(int JourneyCode,int price, TreeNode *x);
	...
	// Deletes the corresponding entry and returns True otherwise
        ...
        bool Remove(int JourneyCode, int price, TreeNode *x);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int CountJourneysInPriceBound(int lowerPriceBound, int upperPriceBound, TreeNode *x);
