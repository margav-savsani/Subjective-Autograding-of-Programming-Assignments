...
struct TreeNode{
    ...
    TreeNode(int jrnyCode, int jrnyPrice,TreeNode* jrnyparent) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr), parent(jrnyparent) {}
...
public:
	...
	bool deleteNode(TreeNode* element);
