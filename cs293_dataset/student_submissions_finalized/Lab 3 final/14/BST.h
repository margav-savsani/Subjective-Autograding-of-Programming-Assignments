...
struct TreeNode{
    ...
    bool sameattributes(TreeNode* another)
    {
        return ((JourneyCode==another->JourneyCode) && (price==another->price));
    }
};
...
public:
	...
	bool find(int JourneyCode, int price);
        ...
        TreeNode* minvaluenode(TreeNode* given); 
	...
	bool remove(int JourneyCode, int price);
        ...
        //utility functions for traverse
        void preorder(TreeNode* given);
        void postorder(TreeNode* given);
        void inorder(TreeNode* given);

        //utility function of customstore
        void storepreorder(TreeNode* given);
	...
	// Methods for Part II
        ...
        // utility function for count journeys
        int utilcountJourneysInPriceBound(TreeNode*r, int l, int u);
	...
	// While loading a tree from a file written by customStore, we
        ...
        //utility function for custom load
        TreeNode* buildtree(int pre[], int*preIndex, int JourneyCode, int price, int min, int max, int size);
