...
struct TreeNode{
    ...
    int price;		// Price
    unsigned short int cnt;  //To store the status of the node while storing
...
public:
	...
	//To find a Journey with the same Journey Code 
	bool find_JC(int *JourneyCode, TreeNode *node);
	...
	//Functions to traverse and print the tree in specific ways
	...
	// Returns the count of journeys that are at least as expensive
		...
		//Recursively counts the number of nodes whose prices lies between lb an ub
        int countPrice(int* lb, int* ub, TreeNode* node, int* count);
