...
struct TreeNode{
    ...
    TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr) ,parent(nullptr){JourneyCode=jrnyCode; price=jrnyPrice;}
    TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent) {JourneyCode=jrnyCode;price=jrnyPrice;right=rightChild;left=leftChild;parent=parent;}
};
...
public:
	...
	TreeNode* successor(TreeNode* k);
	TreeNode* min(TreeNode* k);
	...
	int count(TreeNode* t,int l,int h);
