...
class BST{
	...
	vector<string> result;
        ...
        // Utility functions: to make lyf eezy
        bool journeyCodeExists(int JourneyCode, TreeNode* sub_root);
        void preOrderTraversal(TreeNode* sub_root);
        void postOrderTraversal(TreeNode* sub_root);
        void inOrderTraversal(TreeNode* sub_root);
        ...
        int countJourneysInPriceBound(int lowerPriceBound, int upperPriceBound, TreeNode* sub_root);
        void customStoreWrite(ofstream& out, TreeNode* sub_root);
        TreeNode* customLoadRead(ifstream& in);
