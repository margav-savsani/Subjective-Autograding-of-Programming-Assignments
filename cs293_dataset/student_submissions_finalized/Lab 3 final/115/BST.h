...
public:
	...
	void traverse(int typeOfTraversal);
        void traverse_tree(int typeOfTraversal,TreeNode* B);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int countJourneysInPriceBound2(int lowerPriceBound, int upperPriceBound,TreeNode* root);
	...
	// While loading a tree from a file written by customStore, we
        ...
        TreeNode* myinsert(int JourneyCode,int price,TreeNode* parent,int left);
