...
struct TreeNode{
    ...
    int price;		// Price
    TreeNode *left=NULL;	// Left Child of this Node (NULL, if None)
    TreeNode *right=NULL;	// Right Child of this Node (NULL, if None)
    TreeNode *parent=NULL;	// The Parent Node, NULL in case of Root

    // Constructors
    TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr),parent(nullptr) {price=0;JourneyCode=0;}
    TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr),parent(nullptr) {price=jrnyPrice;JourneyCode=jrnyCode;}
    TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent) {
                                  price=jrnyPrice;JourneyCode=jrnyCode;}
};
...
public:
	...
	int getMinimum();
	void preorder(TreeNode *y);
	void postorder(TreeNode *y);
	void inorder(TreeNode *y);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int count(TreeNode *y,int low,int high);
	...
	// Store the current tree in a file called filename.  You should
        ...
        void s1(TreeNode *x,string filename);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void ds(TreeNode *&z,FILE *fp,int &i);
