...
public:
	...
	//returns ptr of treenode if the given JourneyCode isn't present in the tree, nullptr otherwise
	TreeNode* location(int JourneyCode);
	...
	void storeHelper(ofstream &book);
