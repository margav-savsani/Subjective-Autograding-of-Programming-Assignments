...
public:
	...
	void printBST(const string& prefix, bool isLeft);
        ...
        TreeNode* findSucessor(TreeNode* node);
	...
	bool find(int JourneyCode, int price);
        TreeNode* findNode(TreeNode* node,int JourneyCode, int price);
	TreeNode *findNode(TreeNode *root, int price);
	// Returns false, if JourneyCode isn't present
	// Deletes the corresponding entry and returns True otherwise
	bool remove(int JourneyCode, int price);
	bool removeRecursive(TreeNode* root, int JourneyCode, int price);
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int countJourneysInPriceBound(TreeNode* node,int lowerPriceBound, int upperPriceBound);
	...
	// Store the current tree in a file called filename.  You should
        ...
        void PreOrderStore(TreeNode *node,vector<int> &JourneyCodes,vector<int> &Prices);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void loadBST(TreeNode* &node,TreeNode* parent,vector<int> &JourneyCodes,vector<int> &Prices);
