...
public:
	...
	//Prints preorder traversal of a tree
	...
	// Find successor of node and returns its reference
	...
	// Returns the count of journeys that are at least as expensive
        ...
        int binarySearchMin(vector<int> v, int key);

        int binarySearchMax(vector<int> v, int key);
