...
public:
	...
	BST(TreeNode *root);
        ...
        TreeNode* getMinimum(TreeNode* t);
	void preorder( TreeNode * t);
        void postorder( TreeNode * t);
        void inorder( TreeNode * t);
        TreeNode* loadTree(TreeNode* node, int maxprice, vector<int>jc, int* ijc, vector<int>price, int* ip);
	...
	// Methods for Part II
        ...
        void countJourneys(TreeNode* node, int lowerBound, int upperBound, int* counter);
