...
public:
    ...
    void preorder(TreeNode *startpoint);
    void inorder(TreeNode *startpoint);
    void postorder(TreeNode *startpoint);
    ...
    // Recursive function that does the storing
    void recStore(TreeNode * base, ofstream &out);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void customLoad (int flag, string filename);
            ...
            // Recursive function that does the loading
        void customLoadRec(ifstream &in, TreeNode *&Node);
};
