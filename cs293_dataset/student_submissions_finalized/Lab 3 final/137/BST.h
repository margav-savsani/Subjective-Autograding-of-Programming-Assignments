...
public:
	...
	int getMinimum();
        ...
        struct TreeNode* succesor(struct TreeNode* root);
	...
	// While loading a tree from a file written by customStore, we
        ...
        void preorderfile(ofstream &outfile);

        void Tree(int journey[],int price[],int &index,int val_journey,int val_price,int max,int min,int num);
