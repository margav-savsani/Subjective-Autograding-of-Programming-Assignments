...
public:
        ...
        BST();
        BST(TreeNode *root);
        void order(TreeNode *TN,int t);
        TreeNode* Search(TreeNode *s, int price,int JourneyCode);
        bool del(TreeNode *node, int price);
        TreeNode *pre(TreeNode *node,int price);
        TreeNode *merge(TreeNode* l,TreeNode* r);
        TreeNode* delet(TreeNode* t,int price,int JourneyCode);
        int range(TreeNode* t,int l,int u);
