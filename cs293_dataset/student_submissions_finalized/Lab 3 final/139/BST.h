...
public:
        ...
        // Returns predecessor of given node, if it exists else, nullptr
        TreeNode *getPredecessor(TreeNode *node);
        // Returns successor of given node, if it exists else, nullptr
        TreeNode *getSuccessor(TreeNode *node);
        // Returns the minimum of tree with root root.
        TreeNode *getMin(TreeNode *root);
        // returns maximum of tree with root root.
        ...
        // prints on cout the journey codes (one per line) encountered on traversing the given root's BST in pre_order
        void print_preorder(TreeNode *root);
        // prints on cout the journey codes (one per line) encountered on traversing the given root's BST in post_order
        void print_postorder(TreeNode *root);
        // prints on cout the journey codes (one per line) encountered on traversing the given root's BST in in_order
        ...
        TreeNode *InsertIntoArray(TreeNode *node);
        void write(ofstream &s, TreeNode *node);
        void ToArray(TreeNode *node, int *A, int position);
        bool find_(int price);
        void populateTreeFromArray(TreeNode *r, int *arr, int n, int pos);
