...
public:
	...
	// While loading a tree from a file written by customStore, we
        ...
        bool find_help(int jc,int pr,TreeNode*root);
        void insert_help(int jc,int pr,TreeNode*r1);
        void mintree(TreeNode*r1);
        void pre_traverse(TreeNode*r);
        void post_traverse(TreeNode*r);
        void in_traverse(TreeNode*r);
        int count(int lowerPriceBound, int upperPriceBound,TreeNode*r,int&c);
};
