...
class Planner {
 ...
 public:
  ...
  int partition(listOfObjects<TrainInfoPerStation *> *stnInfoList, int start, int end, int K, vector <listOfObjects<TrainInfoPerStation *> *> pointerArray);
  bool isGreater(TrainInfoPerStation* first, TrainInfoPerStation* second);
  void swap(listOfObjects<TrainInfoPerStation *> *first, listOfObjects<TrainInfoPerStation *> *second);
  bool isEqual(TrainInfoPerStation* first, TrainInfoPerStation* second);
  // End lab 7 specific
};
