...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *> * partition(listOfObjects<TrainInfoPerStation *> *l, listOfObjects<TrainInfoPerStation *> *pivot, listOfObjects<TrainInfoPerStation *> *end );
