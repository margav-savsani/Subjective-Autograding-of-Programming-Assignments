...
class Planner {
 ...
 public:
  ...
  bool isLess(listOfObjects<TrainInfoPerStation *> *node1, listOfObjects<TrainInfoPerStation *> *node2);
  //bool CompareSwap(listOfObjects<TrainInfoPerStation *> *node, listOfObjects<TrainInfoPerStation *> *node1, listOfObjects<TrainInfoPerStation *> *node2);
  listOfObjects<TrainInfoPerStation *>* randomPivot(listOfObjects<TrainInfoPerStation *> **arr, listOfObjects<TrainInfoPerStation *> *node, int start, int end, int K, int N);
    
    listOfObjects<TrainInfoPerStation *> * Partition(listOfObjects<TrainInfoPerStation *> *head, listOfObjects<TrainInfoPerStation *> *tail, listOfObjects<TrainInfoPerStation *> *pivot);
