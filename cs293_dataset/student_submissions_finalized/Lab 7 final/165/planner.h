...
class Planner {
 ...
 public:
  ...
  int partition(int start,int end,listOfObjects<TrainInfoPerStation *>* *startptr, listOfObjects<TrainInfoPerStation *>* *endptr, int K, listOfObjects<TrainInfoPerStation*>* * arr);
