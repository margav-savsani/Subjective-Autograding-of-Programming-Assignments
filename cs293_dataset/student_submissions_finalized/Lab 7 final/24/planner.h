...
class Planner {
 ...
 public:
  ...
  int Partition(listOfObjects<TrainInfoPerStation *> *stnInfoList, int start, int end, int K, int length,listOfObjects<TrainInfoPerStation *>* *A);
  int day(TrainInfoPerStation * x);
  bool great(TrainInfoPerStation *u,TrainInfoPerStation *v);
