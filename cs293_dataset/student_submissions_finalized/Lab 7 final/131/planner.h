...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *> * partition(listOfObjects<TrainInfoPerStation *> * start ,listOfObjects<TrainInfoPerStation *> * finish,int K,listOfObjects<TrainInfoPerStation *> * *array);
  int partitionsimple (listOfObjects<TrainInfoPerStation *> *stnInfo,int K,listOfObjects<TrainInfoPerStation *> * *array,int p,int q);
