...
class Planner {
 ...
 public:
  ...
  // Lab 7 specific
  // void pointerexchange(listOfObjects<TrainInfoPerStation *> *first, listOfObjects<TrainInfoPerStation *> *second);
  int Partition(listOfObjects<TrainInfoPerStation  *> *ending,listOfObjects<TrainInfoPerStation  *> *starting, int start , int end);
