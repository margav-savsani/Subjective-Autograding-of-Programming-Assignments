...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *> *Partion(listOfObjects<TrainInfoPerStation *> *Start, listOfObjects<TrainInfoPerStation *> *end,listOfObjects<TrainInfoPerStation *> *pivot,int s,int e);
  listOfObjects<TrainInfoPerStation *> *pivot(listOfObjects<TrainInfoPerStation *> **stnInfo,int k,int start,int end);
  // End lab 7 specific
};
