...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *>* partition(listOfObjects<TrainInfoPerStation *> *start,listOfObjects<TrainInfoPerStation *> *end,listOfObjects<TrainInfoPerStation *>** arr,int K);
