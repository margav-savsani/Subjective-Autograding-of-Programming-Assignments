...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *> *partitionfunc1(listOfObjects<TrainInfoPerStation *> *h, listOfObjects<TrainInfoPerStation *> *initial, listOfObjects<TrainInfoPerStation *> *final, int &range);
