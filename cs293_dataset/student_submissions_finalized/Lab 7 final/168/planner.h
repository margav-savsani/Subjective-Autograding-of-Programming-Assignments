...
class Planner {
 ...
 public:
  ...
  int partition(listOfObjects<TrainInfoPerStation *> *stnInfoList,int start,int end,listOfObjects<TrainInfoPerStation*>*pivot);
  bool lessThan(TrainInfoPerStation*train1,TrainInfoPerStation*train2);
  int partition(listOfObjects<TrainInfoPerStation *> *stnInfoList,listOfObjects<TrainInfoPerStation*>* pivot,int num,listOfObjects<TrainInfoPerStation *>*tempMore,listOfObjects<TrainInfoPerStation*>*tempLess,listOfObjects<TrainInfoPerStation*>*&firstTrain);
  // End lab 7 specific
};
