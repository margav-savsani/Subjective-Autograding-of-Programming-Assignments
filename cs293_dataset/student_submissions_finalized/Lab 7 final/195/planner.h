...
class Planner {
 ...
 public:
  ...
  int Partition(listOfObjects<TrainInfoPerStation*>*set,int a,int b,int c,listOfObjects<TrainInfoPerStation*>*arr1[]);
  int day(listOfObjects<TrainInfoPerStation*>*w);
  void exchange(listOfObjects<TrainInfoPerStation*>* d,listOfObjects<TrainInfoPerStation*>* e);
  // End lab 7 specific
};
