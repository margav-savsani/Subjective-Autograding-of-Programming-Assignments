...
class Planner {
 private:
  ...
  // int Planner::partition(listOfObjects <TrainInfoPerStation *> *sIL, listOfObjects <TrainInfoPerStation *> *pN, int start, int end);
  // End lab 7 specific
  ...
  int partition(listOfObjects<TrainInfoPerStation *> *stnInfo, listOfObjects<TrainInfoPerStation *> *pivot, int start, int end);
