...
class Planner {
 ...
 public:
  ...
  int Partition(int start,int finish,listOfObjects<TrainInfoPerStation *> *startlist,listOfObjects<TrainInfoPerStation *> *finallist,listOfObjects<TrainInfoPerStation *> *x);
  // End lab 7 specific
};
