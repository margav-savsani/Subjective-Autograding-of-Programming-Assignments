...
class Planner {
 ...
 public:
  ...
  // Lab 7 specific
  int partition(listOfObjects<TrainInfoPerStation *> *start ,listOfObjects<TrainInfoPerStation *> *pivot,listOfObjects<TrainInfoPerStation *> *end,int &n); 
  listOfObjects<TrainInfoPerStation *> *Partition(listOfObjects<TrainInfoPerStation *> *start ,listOfObjects<TrainInfoPerStation *> *pivot,listOfObjects<TrainInfoPerStation *> *end,int len);
