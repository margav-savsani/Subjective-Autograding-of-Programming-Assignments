...
class Planner {
 ...
 public:
  ...
  // Lab 7 specific
  int Partition(listOfObjects<TrainInfoPerStation *> *stnInfolist,listOfObjects<TrainInfoPerStation *> *last,listOfObjects<TrainInfoPerStation *> *p,int start,int end,int K);
