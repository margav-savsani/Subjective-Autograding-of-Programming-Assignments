...
class Planner {
 ...
 public:
  ...
  // int Partition(int start, int finish, TrainInfoPerStation** arr);
  int Partition(listOfObjects<TrainInfoPerStation *> *stnInfoList, int start, int finish, int K, listOfObjects<TrainInfoPerStation *> ** arr);
