...
class Planner {
 ...
 public:
  ...
  // Lab 7 specific
  listOfObjects<TrainInfoPerStation *> * Partition( listOfObjects<TrainInfoPerStation *> *start);
  bool isLessThan(listOfObjects<TrainInfoPerStation *> *l, listOfObjects<TrainInfoPerStation *> *m);
  void Qui_sort(listOfObjects<TrainInfoPerStation *> *start, listOfObjects<TrainInfoPerStation *> *last, int k);
  void Swap(TrainInfoPerStation* l, TrainInfoPerStation* m);
  listOfObjects<TrainInfoPerStation *> ** Array(listOfObjects<TrainInfoPerStation *> *start, int k);
  listOfObjects<TrainInfoPerStation *> * Partition_rp(listOfObjects<TrainInfoPerStation *> *start, int k);
  listOfObjects<TrainInfoPerStation *> *lastNode(listOfObjects<TrainInfoPerStation*> *start);
  listOfObjects<TrainInfoPerStation *> *pivotChoice( listOfObjects<TrainInfoPerStation *> *stnInfoList, int k);
