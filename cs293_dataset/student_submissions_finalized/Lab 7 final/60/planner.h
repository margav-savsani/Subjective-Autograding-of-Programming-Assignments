...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *> * pivot(listOfObjects<TrainInfoPerStation *> **midStn, int K, int start, int end);
  void Swap(listOfObjects<TrainInfoPerStation *> *leftStn, listOfObjects<TrainInfoPerStation *> *rightStn);
  bool Compare(TrainInfoPerStation * a, TrainInfoPerStation * b);
  bool Equal(TrainInfoPerStation * a, TrainInfoPerStation * b);
  void partition(listOfObjects<TrainInfoPerStation *> **midStn, int K, int start, int end, int &m, int &n);
