...
class Planner {
 ...
 public:
  ...
  listOfObjects<TrainInfoPerStation *> * Partition(listOfObjects<TrainInfoPerStation *> *stnInfoList, int first, int last, listOfObjects<TrainInfoPerStation *> * *arr, int i, int j );
  // End lab 7 specific
};
