...
bool BST::insert(int JourneyCode, int price) {
    ...
    while(true){
        ...
        else if(current_node->price < price){
...
bool BST::find(int JourneyCode, int price) { 
    TreeNode* current_node;
    while(true){
        if(current_node->JourneyCode==JourneyCode){
            return true;
        }
        else if(current_node->left->JourneyCode==JourneyCode){
            return true;
        }
        else if(current_node->right->JourneyCode==JourneyCode){
            return true;
        }
        else {
            if(root->price > price){
