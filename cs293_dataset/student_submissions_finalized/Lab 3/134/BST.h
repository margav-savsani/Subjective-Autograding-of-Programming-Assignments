...
struct TreeNode{
    ...
    TreeNode() : price(0), JourneyCode(0), left(nullptr), right(nullptr), identity(0) {}
    TreeNode(int jrnyCode, int jrnyPrice) : price(jrnyPrice), JourneyCode(jrnyCode), left(nullptr), right(nullptr), identity(0) {}
    TreeNode(int jrnyCode, int jrnyPrice, TreeNode *leftChild, TreeNode *rightChild, TreeNode *parent) : price(jrnyPrice), JourneyCode(jrnyCode), left(leftChild), right(rightChild), parent(parent), identity(0) {}
};
...
public:
	...
	bool find(int JourneyCode, int price);
        TreeNode *find(TreeNode *root_var, int price);
        
        TreeNode *TreeSuccessor(TreeNode *var);
	...
	int getMinimum();
        TreeNode *TreeMinimum(TreeNode *var);

        void preorder(TreeNode *var);
        void postorder(TreeNode *var);
        void inorder(TreeNode *var);
