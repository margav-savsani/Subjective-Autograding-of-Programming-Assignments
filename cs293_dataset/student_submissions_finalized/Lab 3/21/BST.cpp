...
bool BST::insert(int JourneyCode, int price) { 
    ...
    while(true){
        if (insert->JourneyCode==NULL){
            insert->JourneyCode=JourneyCode;
            return true;
        }
        else if (insert->JourneyCode < JourneyCode){
...
bool BST::find(int JourneyCode, int price) { 
    ...
    while (search == NULL){
        ...
        else if (search->JourneyCode > JourneyCode){
            search = search->left;
        }
        else return true;
    }
...
bool BST::remove(int JourneyCode, int price) { 
    ...
    if(i==1){
       if(search->left==NULL && search->right==NULL){
        if (search->JourneyCode > search->parent->JourneyCode){
            search->parent->right=NULL;
            search = NULL;
        }
        else if (search->JourneyCode > search->parent->JourneyCode){
        ...
        TreeNode * left = search->left;
        TreeNode *right = search->right;
        TreeNode *parent = search->parent;
        if (left->left != NULL) {
