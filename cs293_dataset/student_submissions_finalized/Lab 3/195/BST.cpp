...
bool BST::insert(int JourneyCode, int price) {
        TreeNode* c=TreeNode(JourneyCode,price);
...
void BST::traverse(int typeOfTraversal) {
         if(typeOfTraversal==1){
             ...
             if(f->left!=NULL){
               ...
               cout<<f->JourneyCode<<endl;
               TreeNode* g=f->parent;
               while(g!=NULL){
               if(g->left==f){
                  if(g->right!=NULL){
                    TreeNode* i=g->right;
                     cout<<i->JourneyCode<<endl;
                     cout<<g->JourneyCode<<endl;
                     }
                  else{
                     cout<<g->JourneyCode<<endl;
                     }
              ...
              if(left.root!=NULL && right.root!=NULL){
                cout<<root-JourneyCode<<" "<<left.traverse(0)<<" "<<right.traverse(0);
                }
              else if(left.root!=NULL){
                  cout<<root-JourneyCode<<" "<<left.traverse(0);
                  }
              else if(right.root!=NULL){
                   cout<<root->JourneyCode<<" "<<right.traverse(0);
                   }
              else{
