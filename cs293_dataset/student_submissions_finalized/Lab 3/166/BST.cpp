...
if(s!=NULL){
    delete s;
    s = new TreeNode(root->jrnyCode, root->jrnyPrice,)
}else{
    s = new TreeNode(...)
}
TreeNode *q;
...
bool BST::insert(int JourneyCode, int price) {
    ...
    if(find(JourneyCode,price)) return false;
        ...
        while(i){
            ...
            else if(s->price>price && s->left==nullptr){
                s->left->JourneyCode=JourneyCode;
                s->left->price=price;
                s->left->parent=s;
                i=false;
                }
            else if(s->price<price && s->right!=nullptr){
                s=s->right;
                }
            else if(s->price<price && s->right==nullptr){
                s->right->JourneyCode=JourneyCode;
                s->right->price=price;
                s->right->parent=s;
                i=false;
                }
