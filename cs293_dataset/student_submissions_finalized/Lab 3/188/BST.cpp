...
bool BST::insert(int JourneyCode, int price)
{
    ...
    TreeNode node(JourneyCode, price);
    TreeNode *ins = &node;
    TreeNode *son = root;
    ...
    if (ins->price <= father->price)
    {
        cout << "Enter5" << endl;
        father->left = ins;
    }
    else father->right = ins;
    return true;
...
bool BST::find(int JourneyCode, int price)
{
    ...
    while (start != NULL)
    {
        cout<<"Enter"<<endl;
        cout<<start->JourneyCode <<" "<< start->price<<endl;
        cout<<ins->JourneyCode <<" "<< ins->price<<endl;
        if (start->JourneyCode == ins->JourneyCode && start->price == ins->price)
        {
            cout<<"Enter1"<<endl;
            return true;
        }
        else if (ins->price <= start->price)
        {
            cout<<"Enter2"<<endl;
            start = start->left;
        }
