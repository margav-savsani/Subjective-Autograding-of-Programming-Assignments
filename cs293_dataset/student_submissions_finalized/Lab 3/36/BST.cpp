...
bool BST::remove(int JourneyCode, int price)
{
    ...
    if (is_left) // target is left of its parent
    {
        // 1
        ...
        {
            TreeNode *temp2 = successor(temp->left);
            temp->left->price = temp2->price;
            temp->left->JourneyCode = temp2->JourneyCode;
            temp2 = nullptr;
            return true;
        }
    }
    else // target is right of its parent
    {
        // 1
        ...
        {
            TreeNode *temp2 = successor(temp->right);
            temp->right->price = temp2->price;
            temp2->right->JourneyCode = temp2->JourneyCode;
            temp2 = nullptr;
            return true;
        }
    }
