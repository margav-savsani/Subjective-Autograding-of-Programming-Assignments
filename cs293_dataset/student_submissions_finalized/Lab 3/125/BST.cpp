...
// Returns the pointer to the desired Node, returns NULL if node not found
TreeNode* BST::findNode(int JourneyCode, int price){
    ...
    if(root->price<=price){
        root = true_root->right;
        TreeNode* ans = findNode(JourneyCode,price);
        root = true_root;
        return ans;
    }
    else{
...
bool BST::remove(int JourneyCode, int price){
    ...
    TreeNode* to_be_removed = findNode(JourneyCode,price);
    if(to_be_removed->right==NULL&&to_be_removed->left==NULL){
        to_be_removed=NULL;
    }
        ...
        *to_be_removed = *to_be_removed->left;
        ...
        TreeNode* successor = to_be_removed->right;
        ...
        to_be_removed->price = final_price;
        to_be_removed->JourneyCode = final_code;
    }
    return true;
}
