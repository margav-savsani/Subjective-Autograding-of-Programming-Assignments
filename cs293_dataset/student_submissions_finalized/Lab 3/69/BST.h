...
public:
	...
	// While loading a tree from a file written by customStore, we
        ...
        int count(TreeNode *a, int lowerPriceBound, int upperPriceBound);
        bool findfunc(TreeNode *p, int JourneyCode, int price);
        bool ins(TreeNode *p,int JourneyCode,int price);
        ...
        TreeNode* retnode(TreeNode *r, int JourneyCode, int price);
};
