...
TrainInfoPerStation* match(int station1, int station2){
  TrainInfoPerStation* matched = new TrainInfoPerStation[DICT_SIZE];
  while(true){
    adjacency[station1].StationAdjacencyList
  }
}

void Planner::printPlanJourneys(string srcStnName, string destStnName, int maxStopOvers, int maxTransitTime)
{
  //My approach will be to  modify the code submitted in lab 9
  ...
  //MODIFICATION
  TrainInfoPerStation *parent_trains = new TrainInfoPerStation[DICT_SIZE];
