...
bool AVLTree::rotateLeftLeft(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode)
{
  ...
  if(greatGrandParentNode == nullptr){
    ...
    // grandParentNode->left = parentNode->right; parentNode->right->parent = grandParentNode;
    updateAVLParentChild(parentNode->right, grandParentNode, true);
    // parentNode->right = grandParentNode; grandParentNode->parent = parentNode;
...
bool AVLTree::rotateLeftRight(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode)
{
  ...
  if(greatGrandParentNode == nullptr){
    rotateRightRight(T3, currNode, parentNode);
...
{
  // Implement this yourself// Going back to Prof. Naveen Garg's lecture, x is *currNode,
  // y is *parentNode and z is *grandParentNode
  ...
  if(greatGrandParentNode == nullptr){
    rotateLeftLeft(T2, currNode, parentNode);
    rotateRightRight(parentNode, currNode, grandParentNode);
    return true;
  }
...
bool AVLTree::rotateRightRight(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode)
{
  ...
  if(greatGrandParentNode == nullptr){
    parentNode->parent = nullptr;
    // grandParentNode->right = parentNode->left; parentNode->left->parent = grandParentNode;
    updateAVLParentChild(parentNode->left, grandParentNode, false);
    // parentNode->left = grandParentNode; grandParentNode->parent = parentNode;
  ...
  while(true){
    if(AVLLessThan(toadd, check)){
      if(check->left != nullptr){
        ...
        check->left = toadd;
        update(toadd);
        TreeNode* imbalance = firstImbalance(toadd);
        if(imbalance != nullptr) balance(imbalance);
        return true;
      }
    }
    else{
...
int AVLTree::find(int jrnyCode)
{
  ...
  while(currnode != nullptr){
    if(AVLLessThan(temp, currnode)){
      // cout << currnode->getJourneycode() << " left\n";
      currnode = currnode->left;
    }
    else if(AVLLessThan(currnode, temp)){
...
bool AVLTree::remove(int jrnyCode)
{
  ...
  if(node->left == nullptr && node->right == nullptr){
    ...
    update(a);
    TreeNode* imbalance = firstImbalance(a);
    if(imbalance != nullptr) balance(imbalance);
    return true;
  }
  ...
  *node = temp;
  update(currNode);
  TreeNode* imbalance = firstImbalance(currNode);
  if(imbalance != nullptr) balance(imbalance);
