...
public:
  ...
  TreeNode(int jrnyCode, int jrnyPrice, TreeNode *left, TreeNode *right, TreeNode *parent)
  {
    JourneyCode = jrnyCode;
    price = jrnyPrice;
    this->left = left;
  ...
  void setJourneyCode(int jrnycode)
  {
    JourneyCode = jrnycode;
  }
...
// as a parameter
 ...
 TreeNode* findSuccessor(TreeNode* node)
   ...
   void setHeights(TreeNode* node)
  {
   ...
   void setAllHeights(TreeNode* node)
  {
    while(node != NULL)
    {
      setHeights(node);
