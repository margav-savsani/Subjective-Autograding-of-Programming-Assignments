...
public:
  ...
  int getprice()
  {
    return price;  // returns the value of price.
  }
  int getjourney()
  {
    return JourneyCode;   // returns the value of journey code.
  }
  ...
  bool updateParentChild(TreeNode *parentNode, bool isLeftChild)
  {
    ...
    bool updateParentChild2(TreeNode *parentNode, bool isRightChild)
  {
    if (parentNode != nullptr) {
      parent = parentNode;
      if (isRightChild) {
