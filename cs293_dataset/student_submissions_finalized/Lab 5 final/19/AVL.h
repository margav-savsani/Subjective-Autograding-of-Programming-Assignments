...
private:
  ...
  void updateAVLParentChild2(TreeNode *childNode, TreeNode *parentNode, bool isRightChild)
  {
    if ((childNode != nullptr) && (parentNode != nullptr)) {
      childNode->updateParentChild2(parentNode, isRightChild);
      totalParentChildUpdateCost += perParentChildUpdateCost;
    }
    else if ((childNode == nullptr) && (parentNode != nullptr)) {
      if (isRightChild) {
