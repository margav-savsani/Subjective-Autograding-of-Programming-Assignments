...
private:
  ...
  //update height of all nodes in the path of 'node' to 'root'
  bool updateHeightAlongPath(TreeNode* node);

  //update height of only the given 'node'
  bool updateHeight(TreeNode* node);

  TreeNode* findgrandpa(TreeNode* node);
