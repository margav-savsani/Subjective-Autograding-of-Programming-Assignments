...
public:
  ...
  bool insertRecursive(int JourneyCode, int price, TreeNode* myroot);//Recursively calling
  void updateHeight(TreeNode* mynode);//updates height of all ancestors of mynode
