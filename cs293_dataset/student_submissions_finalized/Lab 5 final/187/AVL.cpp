...
bool AVLTree::rotateLeftLeft(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode)
{
  ...
  grandParentNode->height = Height(grandParentNode);
...
bool AVLTree::rotateRightLeft(TreeNode *currNode, TreeNode *parent, TreeNode *grandParent)
{
  ...
  updateAVLParentChild(currNode, greatGrandParent, isGPRightChild);
    ...
    if(root == NULL){
      ...
      while(x != NULL){
        ...
        while(a != NULL){
          ...
          while(c != NULL){
            if(imbalance(c) > 1 || imbalance(c) < -1){
              b = c;
              break;
            }
              c = c->parent;
            ...
            if(b != NULL){
            if(imbalance(b) > 1 && Height(b) == Height(b->left)+1 && Height(b->left) == Height(b->left->left)+1){
              cout << "1" << endl;
              rotateLeftLeft(b->left->left,b->left,b);
            }
            else if(imbalance(b) > 1 && Height(b) == Height(b->left)+1 && Height(b->left) == Height(b->left->right)+1){
              cout << "2" << endl;
              rotateLeftRight(b->right->right,b->right,b);
            }
            else if(imbalance(b) < -1 && Height(b) == Height(b->right)+1 && Height(b->right) == Height(b->right->right)+1){
              cout << "3" << endl;
              rotateRightRight(b->right->left,b->right,b);
            }
            else if(imbalance(b) < -1 && Height(b) == Height(b->right)+1 && Height(b->right) == Height(b->right->left)+1){
              cout << "4" << endl;
              rotateRightLeft(b->left->right,b->left,b);
            }
            }
  return true;
}
