...
private:
  ...
  //this is my operator and while using it also it will add to totalcomparision cost
  bool BSTGreaterThan(TreeNode* leftArg, TreeNode *rightArg) {
    if ((leftArg != nullptr) && (rightArg != nullptr)) {
      bool result = (*leftArg > *rightArg);
      totalComparisonCost += perComparisonCost;
      return result;
  ...
  //at every insert this function is called.it updates height of every node of tree
