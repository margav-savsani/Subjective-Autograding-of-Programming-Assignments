...
public:
  ...
  //function to update height, you basically send a request,
  //if the height of node at the time of insertion is less than the requested height update,
  //we update the height and return true else false
  bool insertUpdateHeight(int h){
    if (h>height){ 
      height=h;
      return true;
    }
