...
public:
	...
	int getJourneyCode()		// get Journey Code of a Node
	{
		return JourneyCode;
	}

	int getPrice()				// get Price of a Node
	{
		return price;
	}
	int *changeJourneyCode()	// get the Pointer to the Journey Code
	{
		return &JourneyCode;
	}

	int *changePrice()			// get the Pointer to the price
	{
		return &price;
	}

	int getBalance()			// Function to get the balance factor of a Node
	{
