...
//updated the parent and child in the tree
...
public:
  ...
  // for updtating heights after insertion
  ...
  bool correctImbalance(TreeNode* node);
  void rotate(TreeNode* parent, TreeNode* node, TreeNode* prevNode);
};
