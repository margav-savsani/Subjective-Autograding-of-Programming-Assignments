...
public:
  ...
  void comparisioncost(int x) { totalComparisonCost += perComparisonCost*x; }
  void parentchildupdatecost(int x) { totalParentChildUpdateCost += perParentChildUpdateCost*x; }
