...
public:
  ...
  //In find we are supposed to return the journey price but since it is in private
  //section of the class Treenode I am creating this function to get it's price.
  int getprice(){
    return price;
  }
};
