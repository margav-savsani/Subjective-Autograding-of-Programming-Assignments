...
bool BST::insert(int jrnyCode, int price)
{
  ...
  while (son != nullptr)
  {
    ...
    if (BSTLessThan(node, father))
    {
      //cout<<"lesser"<<endl;
      son = father->left;
      isLeftChild = true;
    }
    else if (BSTLessThan(father, node))
    {
      //cout<<"greater"<<endl;
      son = father->right;
      isLeftChild = false;
  ...
  updateBSTParentChild(node, father, isLeftChild);
  son=node;
...
int BST::find(int jrnyCode)
{
  ...
  while (start != NULL)
  {
    ...
    else if (BSTLessThan(start, node))
    {
      start = start->right;
    }
    else
