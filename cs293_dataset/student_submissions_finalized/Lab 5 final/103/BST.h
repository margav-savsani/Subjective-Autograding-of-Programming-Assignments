...
public:
  ...
  void insertHelper(TreeNode* insertNode, TreeNode* cnode); // helper function for insert
  int find(int jrnyCode);
  TreeNode* findHelper(int jrnyCode, TreeNode* cnode); // helper function for find
