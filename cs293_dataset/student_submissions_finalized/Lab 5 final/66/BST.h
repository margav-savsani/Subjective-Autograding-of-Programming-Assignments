...
public:
  ...
  // Below 3 functions are extra functions that i have added for some functionality
   
  void updateheight(TreeNode *x);                         // function for updating heights of ancestor nodes after inserting a element
  TreeNode *parent(TreeNode *x,TreeNode node);            // function for finding parentnode for element being added  
