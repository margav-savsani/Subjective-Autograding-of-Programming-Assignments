...
private:
  ...
  TreeNode* myRotateRightRight(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode);
  TreeNode* myRotateRightLeft(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode);
  TreeNode* myRotateLeftRight(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode);
  TreeNode* myRotateLeftLeft(TreeNode *currNode, TreeNode *parentNode, TreeNode *grandParentNode);
...
public:
  ...
  TreeNode* myInsert(int jrnyCode, int price);
