...
public:
  ...
  // void pr() {
  //   cout << "JourneyCode: " << JourneyCode << " price: " << price << endl;
  // }
  ...
  bool updateNodefromNode(TreeNode *secondNode)
  {
    this->JourneyCode = secondNode->JourneyCode;
    this->price = secondNode->price;
  }
};
