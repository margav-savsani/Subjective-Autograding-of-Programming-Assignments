...
public:
  ...
  bool checkimbalance(TreeNode* given); //Function to check for imbalance in the tree.
  int checkchild(TreeNode* child, TreeNode* parent); //Function to check whether child is left or right.
