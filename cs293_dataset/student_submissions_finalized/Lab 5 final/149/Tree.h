...
struct TreeNode
{
  ...
  /// @brief get height of the treenode
  ...
  /// @brief update the height of the current node, called when a childe node is inserted or a few nodes are rotated
  void updateHeight()
  {
    if (this != nullptr)
    {
  ...
  /// @brief update parent of the current node
  /// @param parentNode parent node of the trrenode
  /// @param isLeftChild argument to specify whether this node is left child of the parent or not.
