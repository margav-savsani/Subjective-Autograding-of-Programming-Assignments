...
public:
  ...
  bool leftChild(TreeNode *childNode,TreeNode *parentNode){
    if (childNode==parentNode->left) return true;
    else return false;
  }
  bool rightChild(TreeNode *childNode,TreeNode *parentNode){
    if(childNode==parentNode->right) return true;
    else return false;
  }
  ...
  bool heightCheck(TreeNode *x);
  bool Insert(int jrnyCode, int price, TreeNode* x);
  bool insert(int jrnyCode, int price);
  int Find( int jrnyCode,TreeNode *x);
