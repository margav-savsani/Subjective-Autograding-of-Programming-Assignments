...
int main(int argc, char** argv) {
    ...
    while (cin >> cmd) {
	  ...
	  if (choice == 0) {
	    treeBST->print();
      cout<<"ComparisionCost of BST: "<<treeBST->getComparisonCost()<<endl;
      cout<<"parentchildupdateCost of BST: "<<treeBST->getParentChildUpdateCost()<<endl;
	  }
	  else {
	    treeAVL->print();
      cout<<"ComparisionCost of AVL: "<<treeAVL->getComparisonCost()<<endl;
      cout<<"parentchildupdateCost of AVL: "<<treeAVL->getParentChildUpdateCost()<<endl;
	  }
        } else if (cmd == "EXIT") {
            break;
        }
