...
private:
    ...
    // first compare journey code for two nodes and then returns true
    // if journey code of one code is less than other
    // else returns false
    ...
    // first compare journey code for two nodes and then returns true
    // if journey code of one code is equal to other
    // else returns false
    ...
    // updates the Parent Child in AVL
